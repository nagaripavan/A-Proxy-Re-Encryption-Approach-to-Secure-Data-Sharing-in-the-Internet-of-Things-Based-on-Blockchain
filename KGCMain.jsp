...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome to KGC Main:: <%=application.getAttribute("kgc") %></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr style3"></div>
          <p><img src="images/TA.jpg" width="450" height="252" /></p>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="KGCKeyGenerator.jsp">View Key Request and Generate </a></li>
            <li><a href="KgcViewTransaction.jsp">View Transactions</a></li>
