...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View Data Maniplation Results </h2>
          <p class="infopost style4">&nbsp;</p>
          <p class="infopost style4">	 <iframe src="Results.jsp" style="border:3px;" width="650" height="700"></iframe></p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="clr"></div>
        <div class="gadget">
          <h2 class="star"><span>PCS</span> Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
