...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Remote Data Integrity Checking </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <p align="justify" class="style5"> <form id="form1" name="form1" method="post" action="Client_DataIntegrityConfirm.jsp">
          <table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
           
            <tr>
              <td bgcolor="#FF0000" class="style1 style4"><span class="style6">File Name :- </span></td>
