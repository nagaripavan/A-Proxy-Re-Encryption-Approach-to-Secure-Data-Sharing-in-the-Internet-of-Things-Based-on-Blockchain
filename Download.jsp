    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div align="justify" class="style3"><form action="Download1.jsp" method="post" >
            <table width="524" border="1" align="center" cellpadding="10" cellspacing="0" bordercolor="#333333">
              <tr>
                <td width="192" bgcolor="#A6EDFF"><span class="style1 style9 style12">Enter File Name :-</span></td>
                <td width="240"><span class="style15">
                  <label>
                  <input required name="t1" value="<%=fname %>" type="text"  size="40" />
                  </label>
                </span></td>
              </tr>
              <tr>
                <td width="192" bgcolor="#A6EDFF"><span class="style1 style9 style12">Enter Owner Name :-</span></td>
                <td width="240"><span class="style15">
                  <label>
