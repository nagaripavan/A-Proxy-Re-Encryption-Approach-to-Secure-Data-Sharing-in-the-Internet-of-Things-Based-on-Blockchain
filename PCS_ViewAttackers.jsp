...
<head>
<title>A Proxy Re-Encryption Approach to Secure Data Sharing in the Internet of ThingsBased on Blockchain</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
         	  <p> <iframe src="ViewAttackers.jsp" style="border:3px;" width="700" height="400"></iframe> </p>
          <p class="infopost">&nbsp;</p>
          <p class="infopost">&nbsp;</p>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
