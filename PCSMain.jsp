...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome to  Cloud Service Provider :: <%=application.getAttribute("pcsname") %></h2>
          <p class="infopost style4">&nbsp;</p>
          <p class="infopost style4">&nbsp;</p>
          <p class="infopost style4"><img src="images/Cloud.jpg" width="348" height="294" /></p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="ViewTDResults1.jsp">View Time Delay Results </a></li>
			<li><a href="ViewTPTResults2.jsp">View Throughput Results </a></li>
