...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome to Proxy Main:: <%=application.getAttribute("proxyname") %></h2>
          <p align="justify" class="infopost style3">&nbsp;</p>
          <div class="clr style3"></div>
          <div class="img style3"></div>
          <p><img src="images/Proxy.jpg" width="330" height="335" /></p>
          </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="ViewUsers.jsp">View Data Users </a></li>
            <li><a href="proxy_keyauth.jsp">View Key Request from Data Owner and Provide</a></li>
			<li><a href="proxy_transactions.jsp">View Transactions </a></li>
