...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style1"><a href="index.html" class="style2">A Proxy Re-Encryption Approach to Secure Data Sharing in the Internet of ThingsBased on Blockchain</a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content">
            <p align="justify"><form action="Attack1.jsp" method="post" name="form1" id="form1">
<table border="0" align="left">
	<tr>
		...
		<td>&nbsp;</td>
       	...
       	<tr>
		<td width="223" bgcolor="#FF0000"><span class="style5">Enter File Name :-</span></td>
		<td width="245"><label> <input required name="t1"
			type="text"  size="40" /> </label></td>
	</tr>
	<tr>
		<td bgcolor="#FF0000"><span class="style6"></span></td>
		<td>&nbsp;</td>
	</tr>

	<tr>
		<td bgcolor="#FF0000"><span class="style5">Ur Name  :-</span></td>
